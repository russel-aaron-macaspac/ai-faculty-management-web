...
export function Navbar({ onMenuClick, user = null }: Readonly<NavbarProps>) {
  ...
  return (
    <header className="sticky top-0 z-30 flex h-20 w-full items-center justify-between border-b border-slate-200/80 bg-white/85 px-4 backdrop-blur-xl sm:px-6">
      ...
      <div className="flex items-center gap-3 sm:gap-4">
        <Badge variant="outline" className="hidden sm:inline-flex">Faculty management</Badge>
